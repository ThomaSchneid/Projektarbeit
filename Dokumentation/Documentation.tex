...
\begin{document}
	...
	\end{enumerate}
		...
		Die momentan noch mehr als 1 Pixel breiten Kanten werden nun mit der sogenannten Non-Maximum Suppression ausgedünnt.  Der Algorithmus durchläuft jeden Punkt der Intensitätsmatrix und findet alle Pixel mit dem maximalen Intensitäts- und Richtungswert, wodurch alle fälschlicherweise als Kanten erkannte Pixel geschwärzt.\\
		\\
		BILD EINFÜGEN
		\\
		\\
