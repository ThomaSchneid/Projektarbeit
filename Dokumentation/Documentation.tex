...
\begin{document}
	...
	\section{Begriffsdefinitioen und Erklärungen}
		...
		\subsection{Bildrauschen}
			Unter Rauschen versteht man in der Technik eine zufällige Schwankung, mit welcher eine stabile Größe überlagert wird. Bei Bildrauschen handelt es sich um Störungen, welche die Informationen eines Pixels, beispielsweise Farbe oder Helligkeit, verändern. Je mehr Pixel dadurch in ihren Werten verändert werden, desto höher ist das Rauschen im Bild.\nl 
