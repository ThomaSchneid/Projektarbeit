...
\begin{document}
	...
	\section{Effizienzgewinn durch Kantenverfolgung}
		...
		\subsection{Das Bild durchlaufen}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.5\linewidth] {../Bilder/image_skeleton}
			...
			Grund für diesen Abstand ist unsere Suchmaske. Wir untersuchen immer ein 3$\times$3 Quadrat der jeweils gegenüberliegenden Nachbarn. Für jedes so untersuchte Pixel berechnen wir also für 4 Richtungen, ob es sich um eine Kante handelt. hier unsere 4 Suchmasken:\nl
			
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.5\linewidth] {../Bilder/mask_falling_diagonal}
