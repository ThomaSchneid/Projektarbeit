...
\begin{document}
	...
	\section{Effizienzgewinn durch Kantenverfolgung}
		...
		\subsection{Algorithmus}
			...
			Die Funktion erwartet 2 Argumente, zum einen das Bild (\textit{img}), zum anderen den Abstand in Pixeln (\textit{diff}), welchen die Linien auseinander liegen sollen.\nl
