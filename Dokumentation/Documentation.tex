...
\begin{document}
	...
	\section{Effizienzgewinn durch Kantenverfolgung}
		...
		\subsection{Algorithmus}
			...
			Die Funktion erwartet 2 Argumente, zum einen das Bild (img), zum anderen den Abstand in Pixeln (diff), welchen die Linien auseinander liegen sollen.\nl
			...
			mit whitescreen wird ein weißes Bild mit den Maßen des Originalbildes erstellt.
